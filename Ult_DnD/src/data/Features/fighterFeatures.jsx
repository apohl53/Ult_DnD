...
`,
  ...
  "Combat Superiority": {
    ...
    description: `Level 3: Combat Superiority
    ...
    Maneuvers. You learn three maneuvers of your choice. Many maneuvers enhance an attack in some way. You can use only one maneuver per attack. See Maneuver List on Info Page.
  ...
  "Bonus Proficiency (Cavelier)": {
    name: "Bonus Proficiency (Cavelier)",
  ...
  "Bonus Proficiencies (Rune Knight)": {
    name: "Bonus Proficiencies (Rune Knight)",
    description: `You gain proficiency with smith's tools, and you learn to speak, read, and write Giant.`,
  },
  "": {
    name: "",
    description: `You can use magic runes to enhance your gear. You learn two runes of your choice, from among the runes described below, and each time you gain a level in this class, you can replace one rune you know with a different one from this feature. When you reach certain levels in this class, you learn additional runes, as shown in the Runes Known table. See Info Page for Table.
  ...
  "Giant's Might": {
    name: "Giant's Might",
    description: `You have learned how to imbue yourself with the might of giants. As a bonus action, you magically gain the following benefits, which last for 1 minute:
  ...
  "Great Stature": {
    name: "Great Stature",
    description: `The magic of your runes permanently alters you. When you gain this feature, roll 3d4. You grow a number of inches in height equal to the roll.
  ...
  "Bonus Proficiency (Samurai)": {
    name: "Bonus Proficiency (Samurai)",
...
`,
  ...
  "Nimble Lancer": {
    name: "Nimble Lancer",
    description: `Starting at 3rd level, you are remarkably light on your feet and capable of counterbalancing even some of the most awkward of equipment. Lances have the versatile property for you while you're not mounted, dealing 1d8 piercing damage on a hit when held with one hand and 1d12 piercing damage when wielded with two. When you use your Launch feature and immediately hit with a melee attack using a lance, it counts as if you're wielding it with two hands.
  ...
  "Predatory Instincts": {
    ...
    description: `Starting at 15th level, you have advantage on initiative rolls, and when you roll initiative and have no uses of Launch remaining, you regain one use.`,
  },
  "Improved Launch": {
    name: "Improved Launch",
    description: `Starting at 18th level, when you hit a creature with a melee weapon attack immediately after or during your Launch, it must also succeed on a Strength saving throw (save DC equal to 8 + your proficiency bonus + your Strength modifier) or be knocked prone.
