const options = {
  ...
  "Sorcerer Metamagic": [
    { name: "Quickened Spell", description: "Cast a spell as a bonus action." },
    { name: "Twinned Spell", description: "Target a second creature." },
  ...
  "Warlock Invocations": [
    ...
    {
      name: "Devil's Sight",
      description: "See in magical and non-magical darkness.",
    },
    // etc...
  ],
