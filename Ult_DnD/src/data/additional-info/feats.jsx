export const feats = [
  ...
  },
  {
    name: "Agent of Order",
    prerequisite:
      "Level 4+, Scion of the Outer Planes (Lawful Outer Plane) Feat",
...
`,
  ...
  },
  {
    ...
    prerequisite:
      "Level 4+, Scion of the Outer Planes (Chaotic Outer Plane) Feat",
...
4: Wailing Winds. Winds swirl in a 15-foot-radius sphere centered on you. You and any other creatures in that area have disadvantage on Wisdom saving throws.`,
  ...
  {
    name: "Dragon Fear",
    prerequisite: "Level 4+, Dragonborn",
    description: `When angered, you can radiate menace. You gain the following benefits:
